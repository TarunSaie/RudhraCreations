            ...
            <div className="relative group">
              ...
              <div className="relative z-10 overflow-hidden">
                <img
                  ...
                  alt="T Leela Gowtham Varma, founder of Rudra Creations"
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  ...
                  <p className="font-cinzel text-white text-xl font-bold">T Leela Gowtham Varma</p>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="font-inter text-cinema-text-muted text-base leading-[1.9] mb-5">
                Founded by <strong className="text-white">T Leela Gowtham Varma</strong> in 2018,{" "}
